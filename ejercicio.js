...
{
    name: buscar(paddock[i].farmId)
    manager: buscar2(paddock[i].paddockManagerId)

}
'Agricola santa anda': [6, '78684747', 'JOAQUIN ANDRADE SANDOVAL']
{

}

let buscar = function (input) {
    paddockManagers.find(function () {
